...
@section('content')
        ...
        <div class="col-md-6">
            ...
            <a href="{{url('seller_dashboard')}}" class="btn btn-primary py-md-2 px-md-3 me-2 animated slideInLeft">Seller</a>
            <a href="{{url('buyer_dashboard')}}" class="btn btn-primary py-md-2 px-md-3 me-2 animated slideInLeft">Buyer</a>
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label>Description <span class="text-danger">*</span></label>
                                            ...
                                            <textarea name="description" type="text" cols="40" rows="5" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
