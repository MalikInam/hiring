							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									<div class="doctor-img">
										<img src="{{asset('/uplaod/'.$profile->image) }}" class="img-fluid" alt="User Image">
									</div>
									<div class="doc-info-cont">
										<h4 class="doc-name">{{$profile->first_name}}{{$profile->last_name}}</h4>
										<h6 class="">{{$profile->skill}}</h6>
										<p class="">Seller</p>
									
										
											<h6 class="fas fa-map-marker-alt">{{$profile->location}}</h6>
								...
								<div class="clini-infos">
									...
									<?php
										...
										$userID = Auth::user()->id;
										$total_review = Review::whereseller_id($userID)->count();
										
						

                                        ?>
										<li><i class="far fa-comment"></i> {{$total_review}} Feedback</li>
								...
								<div class="doctor-action">
									...
									<a href="https://api.whatsapp.com/send?phone={{$profile->number}}&text=Hi {{$profile->first_name}}{{$profile->last_name}}" class="btn btn-success">
